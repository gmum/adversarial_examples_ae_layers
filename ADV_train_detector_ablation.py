...
if __name__ == '__main__':
    ...
    group_ablation = parser.add_mutually_exclusive_group()
    group_ablation.add_argument('--only_re', action='store_true', help='train model only on the reconstruction error')
    group_ablation.add_argument('--only_ln', action='store_true', help='train model only on the latent_norm')
